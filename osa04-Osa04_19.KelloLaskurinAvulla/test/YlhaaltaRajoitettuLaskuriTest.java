...
public class YlhaaltaRajoitettuLaskuriTest {
    ...
    public void etunollaAlussa() throws Throwable {
        ...
        assertTrue("Tulostuksessa pitäisi olla mukana etunolla, ks 04-19.2:n tehtävämäärittely! Kun luodaan uusi laskuri, tulostuu " + vastaus, vastaus.contains(odotettu));
    }
    ...
    public void etunollaPysyy() throws Throwable {
        ...
        assertTrue("Tulostuksessa pitäisi olla mukana etunolla, ks 04-19.2:n tehtävämäärittely! Tarkasta seuraava: "
    ...
    public void kelloEtenee() {
        ...
        assertFalse("Tee pääohjelmastasi kello tehtävän 04-19.3 ohjeen mukaan. Poista ensin kaikki ylimääräinen. "
                + "Ensimmäisenä  pitäisi tulostua 00:00", eka == -1);

        assertTrue("Tee pääohjelmastasi kello tehtävän 04-19.3 ohjeen mukaan. Poista ensin kaikki ylimääräinen."
     ...
     */
    @Points("04-19.1 04-19.2 04-19.3 04-19.4")
    @Test
    ...
    public void tarkkaKelloEtenee() {
        ...
        assertFalse("Tee pääohjelmastasi kello tehtävän 04-19.4 ohjeen mukaan.  "
                + "Syötteellä 50 59 23 ensimmäisenä  pitäisi tulostua 23:59:50", eka == -1);

        assertTrue("Tee pääohjelmastasi kello tehtävän 04-19.4 ohjeen mukaan.  "
